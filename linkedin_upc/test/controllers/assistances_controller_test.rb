...
class AssistancesControllerTest < ActionController::TestCase
  ...
  test "should create assistance" do
    assert_difference('Assistance.count') do
      post :create, assistance: { assistance_flag: @assistance.assistance_flag, concert_id: @assistance.concert_id, score: @assistance.score, user_id: @assistance.user_id }
    end
  ...
  test "should update assistance" do
    patch :update, id: @assistance, assistance: { assistance_flag: @assistance.assistance_flag, concert_id: @assistance.concert_id, score: @assistance.score, user_id: @assistance.user_id }
    assert_redirected_to assistance_path(assigns(:assistance))
  end
