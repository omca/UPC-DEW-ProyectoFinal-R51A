...
class AssistancesControllerTest < ActionController::TestCase
  ...
  test "should update assistance" do
    put :update, id: @assistance, assistance: { assistance_flag: @assistance.assistance_flag, concert_id: @assistance.concert_id, score: @assistance.score, user_id: @assistance.user_id }
    assert_redirected_to assistance_path(assigns(:assistance))
  end
