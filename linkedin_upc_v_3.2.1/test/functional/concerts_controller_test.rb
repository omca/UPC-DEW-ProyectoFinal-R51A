...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should update concert" do
    put :update, id: @concert, concert: { band_id: @concert.band_id, begin_time,: @concert.begin_time,, date: @concert.date, end_time: @concert.end_time, local_id: @concert.local_id, name: @concert.name, status: @concert.status }
    assert_redirected_to concert_path(assigns(:concert))
  end
